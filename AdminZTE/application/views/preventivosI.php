                ...
                echo "<div class='wrapperWheel'>";
                  echo "<div class='mainWheel'>";
                    ...
                    echo "<ul id='wheel1'  data-angle='NE' class='wheel'>";
                      ...
                      echo "<li class='item'><div class='cae_texto' style='text-align: left;'><a href='".base_url()."Mantenimientos/editarMP'><img src='".base_url()."assets/images/edit.png' /></a>Edit</div></li>";
                      echo "<li class='item'><div class='cae_texto'><a href='".base_url()."Ticket/ticketCreation'><img src='".base_url()."assets/images/plus.ico' /></a>Plus</div></li>";
                    echo "</ul>";
                    echo "<br><br><br><br>";
                  echo "</div>";
                echo "</div>";
                        ...
                        for ($i = 0; $i <= count($tickets); $i++){
                          if(isset($tickets[$i])){
                            if($tickets[$i]->getEstadoI() == 1){
                              echo "<tr>";
                                echo "<td><a href='".base_url()."Equipment/inventoryPVD?k_fase=".$tickets[$i]->getEstadia()->getFase()."&k_tipo=".$tickets[$i]->getEstadia()->getTipologia()."&k_pvd=".$tickets[$i]->getEstadia()->getID()."&k_ticket=".$tickets[$i]->getId()."'>".$tickets[$i]->getId()."</a></td>";
